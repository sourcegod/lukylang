...
namespace luky {
    ...
    inline std::ostream& operator<<(std::ostream& ost, luky::Token& tok) { return ost << tok.lexeme; } 
    inline std::ostream& operator<<(std::ostream& ost, luky::TokPtr& tokP) { return ost << tokP->lexeme; } 
